...
test("M427 action-count listener registration rolls back an add-then-throw collaborator", () => {
...
test("M427 disposal releases identity even when captured listener removal throws", () => {
...
test("M427 missing optional storage surfaces still return a no-op registration", () => {
