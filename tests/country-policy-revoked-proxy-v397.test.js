...
test("M397 country collection preserves ordinary non-array compatibility and dense behavior", () => {
...
test("M397 revoked collection proxies fail deterministically", () => {
  assert.throws(() => collectCountryRules(revokedProxy([])), /Country policy rules array kind is invalid/);
});

test("M397 revoked parsed-label candidates fail closed without escaping", () => {
