...
test("M844 ancestor ids are used only when uniquely bound to that ancestor", () => {
  ...
  assert.match(source, /depth === 0 \? !duplicateId : stableIdIsUnique\(current, documentRef, probe\)/);
