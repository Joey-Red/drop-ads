...
test("M860 publishes shortcut relationships on the native popup controls", () => {
  ...
  assert.match(html, /id="shortcut-help-list" class="shortcut-list" aria-label="Popup keyboard shortcuts"/);
});
