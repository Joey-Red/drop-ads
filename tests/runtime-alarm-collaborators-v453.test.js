...
test("M453 configured refresh alarm operations are captured once", () => {
...
test("M453 configured clear and create are both awaited and minimum interval remains 60 minutes", () => {
