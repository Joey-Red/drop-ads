...
test("M866 publishes popup shortcut relationships on the exact native controls", () => {
  ...
  assert.match(html, /data-shortcut="g" data-shortcut-control="enabled"/);
  assert.match(html, /data-shortcut="o" data-shortcut-control="settings"/);
});
